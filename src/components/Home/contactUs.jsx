...
const ContactUs = () => {
  return (
    <section id='contactus' className='h-auto py-10 bg-slate-200'>
      <h1 className='text-5xl font-bold text-indigo-950 flex-all-center mb-4'>Contact Us</h1>
      ...
      <section className="mt-6 grid w-5/6 h-full mx-auto lg:grid-cols-4 sm:grid-cols-2 xs:grid-cols-1 xs:gap-6">
        <ContactInfo>
          <MdLocationPin size={54} className='bg-indigo-950 text-white rounded-full p-3' />
        ...
        <ContactInfo>
          <BiWorld size={54} className='bg-indigo-950 text-white rounded-full p-3' />
        ...
        <ContactInfo>
          <SiMinutemailer size={54} className='bg-indigo-950 text-white rounded-full p-3' />
        ...
        <ContactInfo>
          <FaPhoneAlt size={54} className='bg-indigo-950 text-white rounded-full p-3' />
