    ...
    <section id='contactus' className='h-auto py-10 bg-bg text-themeFont'>
      ...
      <section className="mt-6 grid w-5/6 h-full mx-auto lg:grid-cols-4 sm:grid-cols-2 xs:grid-cols-1 xs:gap-6">
        ...
        <ContactInfo>
          ...
          <p className='text-sm w-fit text-center font-semibold  flex flex-col'>Website: <span className='font-normal'>www.promodevelopers.com.pk</span></p>
        </ContactInfo>
        <ContactInfo>
          <SiMinutemailer size={54} className='bg-themeFont text-white rounded-full p-3' />
          <p className='text-sm w-fit text-center font-semibold  flex flex-col'>Email: <span className='font-normal'>promodevelopers@gmail.com</span></p>
        </ContactInfo>
        <ContactInfo>
