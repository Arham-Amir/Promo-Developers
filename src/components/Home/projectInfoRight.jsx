...
const ProjectInfoRight = (props) => {
  return (
    <section className={`${props.className}`}>
      <section className="xs:w-11/12 sm:w-1/3 md:w-[290px] md:h-3/4 sm:h-auto md:mt-12 xs:mx-auto sm:ml-7">
        <Image src="/image/project1.jpg" alt="house pic 1" width={0} height={0}
          className="h-full w-auto object-fill md:mt-14 border" />
      </section>
      <section className="sm:w-2/3 md:w-3/4 h-2/4 flex md:mt-12">
